...
<head>
    ...
    <title>⚗️ AlchiClick — Connexion</title>
...
<div class="auth-box">
    ...
    @if ($errors->any())
        <div style="background:#2a0d0d;border:1px solid #c0392b;border-radius:4px;padding:8px 12px;margin-bottom:14px;font-size:.85rem;color:#e89090;">
            {{ $errors->first() }}
        </div>
    @endif
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <button type="submit" class="btn">Entrer dans l'Athanor</button>
    </form>
